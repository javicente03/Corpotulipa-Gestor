    ...
    <div class="col m12 l9 contenido-principal">
        ...
        <div class="contenedor">
            <p style="text-align: center; background-color: gray; padding: 10px;border-radius: 1em;font-weight: bold;color:black;margin-bottom:10px;">
                ...
                Monto máximo permitido para una transacción de caja chica expresado en Unidades Tributarias
            </p>
            <p style="text-align: center; background-color: gray; padding: 10px;border-radius: 1em;font-weight: bold;color:black;margin-bottom:10px;">
                <i class="material-icons left">error</i>
                El campo Tasa de cambio hace referencia a la cantidad equivalente a 1 Unidad Tributaria
            </p>

        ...
        if (is_numeric($duracion)) {
            if (strlen($motivo) <= 2000) {
                ...
                if (!isset($_POST["externo"]))
                    $texto = $_SESSION["nombre"] . " " . $_SESSION["apellido"] . " ha solicitado un prestamo del bien público a su responsabilidad: $nombre_bien. Por favor indique si esta procederá.";
                else

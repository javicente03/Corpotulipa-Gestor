    ...
    if($clave != ""){
        ...
        if(password_verify($clave, $usuario['password'])){
            ...
            if($inventario){
                ...
                $obtener_total = ($bd->query("SELECT SUM(valor) FROM inventario_data ID LEFT JOIN bienes_publicos B ON ID.id_bien = B.id_bien WHERE id_inventario_departamento =12"))->fetch_assoc();            
